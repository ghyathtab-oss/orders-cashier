(() => {
  ...
  const STORAGE_KEY = 'digitalOrdersCashier_v2';
  ...
  function initialStore(template){
    return {
      ...
      style:template.style, showPrices:true, products:[], history:[]
    };
  }

  function defaultState(){
    return { version:2, activeStoreId:'muslim', stores:Object.fromEntries(STORE_TEMPLATES.map(t => [t.id,initialStore(t)])) };
  }
